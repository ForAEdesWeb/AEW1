...
<div class="system-unpublished">
	...
	<article>
		...
		<section class="article-images clearfix">		
				...
				<a class="images-content"  href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid)); ?>">
					<img
    ...
    <!-- //footer -->
		...
		<section class="article-action clearfix">
			<?php if ($params->get('show_readmore') && $this->item->readmore) :
				...
				?>
				<a class="readmore btn" href="<?php echo $link; ?>" itempro="url">
					<span>
