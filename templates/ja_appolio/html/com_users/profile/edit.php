...
<form id="member-profile" action="<?php echo JRoute::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate form-horizontal" enctype="multipart/form-data">
      ...
      <?php foreach ($this->form->getFieldsets() as $group => $fieldset):// Iterate through the form fieldsets and display each one.?>
        ...
        <?php if (count($fields)):?>
        <fieldset class="col-xs-12 col-md-6 col-sm-6">
  	...
  	<div class="form-actions clearfix">
  			...
  			<a class="btn btn-danger pull-right" href="<?php echo JRoute::_(''); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>
