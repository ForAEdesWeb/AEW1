...
<div class="my-locations-page">
	<h1 class="eb_title eb-page-heading"><?php echo JText::_('EB_LOCATIONS_MANAGEMENT'); ?>
		<span class="add_location_link" style="float: right; font-size:14px;">
			<a href="<?php echo JRoute::_('index.php?option=com_eventbooking&view=location&layout=form&Itemid=' . $this->Itemid); ?>"><i class="fa fa-plus-circle"></i></i> <?php echo JText::_('EB_SUBMIT_LOCATION'); ?></a>
		</span>
	</h1>
