...
?>
<div class="blog<?php echo $this->pageclass_sfx;?> blog-col-<?php echo $this->params->get('num_columns'); ?> event-list" itemscope itemtype="http://schema.org/Blog">
	...
	<div class="category-info">
		...
		<?php if ($this->params->get('show_category_title', 1) or $this->params->get('page_subheading') or $this->params->get('show_description', 1)) : ?>
	...
	<?php foreach ($this->intro_items as $key => &$item) : ?>
		...
		<div class="items-row has-inview cols-<?php echo (int) $this->columns;?> <?php echo 'row-'.$row; ?> row">
		<?php endif; ?>
