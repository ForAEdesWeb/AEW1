...
if ($ja_stylesheet == 'vertical-layout') {
  ...
  $ja_stylesheet = 'horizontal-layout form-horizontal';
}
...
?>
	<li class="form-group" <?php echo $style;?>>
		<label class="group-label control-label"><?php echo JText::_('SEARCH_BY_DATE'); ?></label>
...
if($filter_by_category){
	...
	?>
	<li class="form-group" <?php echo $style;?>>
		<label class="group-label control-label"><?php echo JText::_('JAK2_CATEGORY'); ?></label>
		<?php echo $categories; ?>
	</li>
	<?php
	$clear = '';
